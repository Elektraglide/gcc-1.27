...
#define HAVE_ftruncdf2 (TARGET_68881)
extern rtx gen_ftruncdf2 ();
#define HAVE_ftruncsf2 (TARGET_68881)
...
#define HAVE_fix_truncsfsi2 (TARGET_FPA)
extern rtx gen_fix_truncsfsi2 ();
#define HAVE_fix_truncdfsi2 (TARGET_FPA)
...
#define HAVE_bleu (1)
extern rtx gen_bleu ();
#define HAVE_casesi_1 (1)
extern rtx gen_casesi_1 ();
#define HAVE_casesi_2 (1)
