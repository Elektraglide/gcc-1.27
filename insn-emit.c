...

{
  ...
  operand0 = operands[0];
  operand1 = operands[1];
  emit_insn (gen_rtx (SET, VOIDmode, cc0_rtx, gen_rtx (MINUS, DFmode, operand0, operand1)));
  emit_to_sequence--;
  return gen_sequence ();
}
...

{
  ...
  operand0 = operands[0];
  operand1 = operands[1];
  emit_insn (gen_rtx (SET, VOIDmode, cc0_rtx, gen_rtx (MINUS, SFmode, operand0, operand1)));
  emit_to_sequence--;
  return gen_sequence ();
}
